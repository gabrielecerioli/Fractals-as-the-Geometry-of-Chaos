...
\input{1-Classical models for finance.tex}
...
\end{figure}
\input{2-Black Swans in the stock puddle.tex}

\section{Why fractals: modeling uncertainty through fractal analysis}
\input{3-Why fractals: modeling uncertainty through fractal anal- ysis.tex}
